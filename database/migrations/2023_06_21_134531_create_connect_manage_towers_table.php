...
class CreateConnectManageTowersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('connect_manage_towers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('connect_manage_towers');
    }
}
