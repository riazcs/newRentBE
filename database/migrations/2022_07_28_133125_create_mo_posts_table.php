...
class CreateMoPostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('mo_posts')) {
            Schema::create('mo_posts', function (Blueprint $table) {
                $table->id();
                ...
                $table->string('motel_name')->nullable(); // tên phòng
                $table->string('tower_name')->nullable(); // tên tòa nhà
                ...
                $table->timestamp('time_push')->nullable()->default(DB::raw('CURRENT_TIMESTAMP'));
