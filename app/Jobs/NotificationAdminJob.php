...
class NotificationAdminJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach ($splitToken as $listToken) {
            ...
            $this->subscribeTopic($listToken, $random);
            $this->sendNotification($data, $random);
            $this->unsubscribeTopic($listToken, $random);
        }
    }
