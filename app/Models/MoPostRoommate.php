...
class MoPostRoommate extends BaseModel
{
    use SearchableTrait;
    ...
    protected $searchable = [
        'columns' => [
            'mo_post_roommates.province_name' => 5,
            'mo_post_roommates.district_name' => 5,
            'mo_post_roommates.wards_name' => 2,
            'mo_post_roommates.title' => 10,
            'mo_post_roommates.motel_name' => 5,
            'mo_post_roommates.phone_number' => 1,
        ],
    ];
    ...
    public function getUserAttribute()
    {
        ...
        if ($userExist != null) {
            $userExist->total_post_roommate = DB::table('mo_post_roommates')->where('user_id', $this->user_id)->count();
            return $userExist;
        }
        return $userExist;
    }
