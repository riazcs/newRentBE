...
class NganLuongController extends Controller
{
	...
	public $merchant_site_code = 'saga'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	public $secure_pass= 'd7e664242282a91cf1c49adff5a2ffc3'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
	...
	{	
        ...
        $return_url = $host . "/api/customer/sy/purchase/return/vn_pay";
        $receiver = 'drhoang999@gmail.com';
        $transaction_info = $order_code;
        $order_code =  $order_code; 
        $price = $request->order->total_final; 
        $currency = 'vnd'; 
        $quantity = 1; 
        $tax = 0;
        $discount = 0; 
