...
use App\Models\ReportPostRoommateViolation;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\DB;

class ReportPostRoommateViolationController extends Controller
{
    /**
     ...
     * @queryBody mo_post_roommate_id int 
    ...
    public function create(Request $request)
    {
        ...
        $moPostExist = DB::table('mo_post_roommates')
            ->join('users', 'mo_post_roommates.user_id', '=', 'users.id')
            ->where('mo_post_roommates.id', $request->mo_post_roommate_id)
            ->select('mo_post_roommates.*', 'users.name')
            ->first();
        ...
        $reportPostViolationCreate = ReportPostRoommateViolation::create([
    ...
    public function update(Request $request)
    {
        ...
        $reportPostViolation = request("report_post_roommate_violation_id");

        $reportPostViolationExist = ReportPostRoommateViolation::where(
            'id',
            $reportPostViolation
        )->first();
